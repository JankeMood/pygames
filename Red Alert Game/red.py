#space background and multi-colored stars fall from the top to the bottom, player must click on the red star

#import the random module
import random

#declare constants
FONT_COLOR = (255, 255, 255) #sets font color (black?) (R,G,B)
WIDTH = 800
HEIGHT = 600
CENTER_X = WIDTH / 2
CENTER_Y = HEIGHT / 2
