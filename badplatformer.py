    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                needs_help = event.key != pygame.K_RIGHT and event.key != pygame.K_d and event.key != pygame.K_LEFT and event.key != event.key != pygame.K_a and event.key != pygame.K_SPACE
                if needs_help:
                    help_action = True
